...
### 🏗️ What I Do
* **High-Scale Consumer Experiences:** Architecting server-side ASP.NET e2e travel ecosystems, Copilot LLM integrations, and highly interactive user interfaces.
* **Full-Stack Engineering:** Specialized in building performant, responsive frontends (React, TypeScript) backed by robust backend systems (ASP.NET, C#, Java).
* **AI & Next-Gen UI:** Designing interactive bento/magazine layouts and integrating generative AI/LLM components into production platforms.
...
#### Flipkart | Software Development Engineer 1
...
| :--- | :--- |
| **Languages & Core** | TypeScript, JavaScript, C#, Java, C, HTML5, CSS3/SCSS |
| **Frameworks & Libraries** | React, ASP.NET, AngularJS, MVC, webpack, Playwright |
| **Data & Cloud** | SQL, KQL (Kusto), MySQL, Hadoop, AWS (EC2, S3, RDS, Elastic Beanstalk) |
| **Tools & Workflows** | Git, Azure DevOps, Figma, Postman, Cursor, A/B Testing, Power BI |
